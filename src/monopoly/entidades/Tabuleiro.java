...
public class Tabuleiro {
	...
	/*
	 * private void inicializarCartas() { // Cartas de Community Chest
	 * communityChest.push(new Carta("Avance para o Ponto de Partida (Go)",
	 * "Receba $200")); communityChest.push(new Carta("Erro do banco em seu favor",
	 * "Receba $200")); communityChest.push(new Carta("Taxa do médico",
	 * "Pague $50")); communityChest.push(new Carta("Abertura da Grande Ópera",
	 * "Receba $50 de cada jogador")); communityChest.push(new
	 * Carta("Da liquidação fora de estoque", "Receba $45"));
	 * communityChest.push(new Carta("Saia livre da prisão, sem pagar",
	 * "Mantenha esta carta até o uso ou venda")); communityChest.push(new
	 * Carta("Vá para a prisão", "Vá direto para a prisão"));
	 * communityChest.push(new Carta("Restituição do Imposto de Renda",
	 * "Receba $20")); communityChest.push(new
	 * Carta("Aniversário do seguro de vida", "Receba $100"));
	 ...
	 * communityChest.push(new Carta("Aniversário dos fundos de Natal",
	 * "Receba $100")); communityChest.push(new
	 * Carta("Você tirou o segundo lugar no concurso de beleza", "Receba $10"));
	 * communityChest.push(new Carta("Você herdou", "Receba $100"));
	 * communityChest.push(new Carta("Você deve pagar os reparos da rua",
	 * "Pague $40 por casa e $115 por hotel"));
	 * 
	 * // Cartas de Chance chance.push(new Carta("Avance para o Ponto de Partida",
	 * "Receba $200")); chance.push(new Carta("Avance para Illinois Avenue",
	 * "Mova-se para Illinois Avenue")); chance.push(new
	 * Carta("Avance para St. Charles Place", "Mova-se para St. Charles Place"));
	 * chance.push( new Carta("Avance para o serviço público mais próximo",
	 * "Mova-se para o serviço público mais próximo")); chance.push(new
	 * Carta("Avance para a ferrovia mais próxima",
	 * "Mova-se para a ferrovia mais próxima")); chance.push(new
	 * Carta("O banco lhe pagou dividendos de $50", "Receba $50")); chance.push(new
	 * Carta("Volte 3 espaços", "Mova-se 3 espaços para trás")); chance.push(new
	 * Carta("Vá diretamente para a Prisão", "Vá para a prisão")); chance.push( new
	 * Carta("Faça a manutenção de todas as suas propriedades",
	 * "Pague $25 por casa e $100 por hotel")); chance.push(new
	 * Carta("Pague imposto de pobreza de $15", "Pague $15")); chance.push(new
	 * Carta("Saia livre da prisão", "Mantenha esta carta até o uso ou venda"));
	 * chance.push(new Carta("Dê uma volta na Reading",
	 * "Mova-se para Reading Railroad")); chance.push(new
	 * Carta("Dê uma caminhada no Board Walk", "Mova-se para Boardwalk"));
	 * chance.push(new Carta("Você foi eleito presidente do tabuleiro",
	 * "Pague $50 para cada jogador")); chance.push(new
	 * Carta("Seus empréstimos e investimento fizeram aniversário", "Receba $150"));
	 * 
	 * // Embaralhar as cartas Collections.shuffle(communityChest);
	...
	public Collection<Propriedade> getPropriedades() {
	    ...
	    for (Lugar lugar : lugares.values()) {
	        if (lugar instanceof Propriedade) {
	            propriedades.add((Propriedade) lugar);  // Adiciona apenas as instâncias de Propriedade
	        }
	    }
	    return propriedades;
	}
	public Map<Integer, Propriedade> getPropriedade() {
		return propriedades;
	}
